// Builds the browser router from the manifest in routes.ts. Each page is a
// lazy chunk; BaseLayout renders them inside its Suspense boundary, and
// `bare` routes render on their own outside the shell.
